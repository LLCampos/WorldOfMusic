...
function addUserToDatabase(response) {
  ...
  $.ajax({
    ...
    method: "POST",
    data: {id: id, email: email, first_name: first_name , last_name: last_name, age_range: age_range, gender: gender, locale: locale, timezone: timezone, updated_time: updated_time, access_token: access_token},
